        ...
        <div className="hom">
            ...
            <main className="beschreib">
                ...
                <div>
                    <img
                        ...
                        src="https://img.freepik.com/free-vector/project-management-goal-completion-list-questionnaire-survey-answering-business-organization-tool_335657-3289.jpg"
                        alt=""
                    />
                </div>
            </main>
            <section className="beschreib">
                ...
                <div>
                    ...
                    <img
                        className="beschreib_img"
                        src="https://www.ntaskmanager.com/wp-content/uploads/2021/02/Task-management-vs-project-management.jpg"
                        alt=""
                    />
                </div>
            </section>
